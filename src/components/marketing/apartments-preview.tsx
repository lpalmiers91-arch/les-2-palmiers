        ...
        <Reveal className="flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-xl">
            <h2 className="display text-[2.1rem] leading-[1.06] text-ink sm:text-[2.7rem]">
              {s(content.title, "Nos appartements,")}
              <br />
              <span className="italic font-normal text-forest-2">
                {s(content.titleEm, "au calme, en hauteur.")}
              </span>
            </h2>
            <p className="measure mt-6 text-[1.02rem] leading-relaxed text-ink-2">
              {s(
                content.lede,
                "Chacun entièrement meublé et prêt à l'arrivée, avec la même conciergerie 7 j/7 à vos côtés.",
              )}
            </p>
          </div>
          <Link
          ...
          >
            Voir tous les appartements <ArrowRight className="h-3.5 w-3.5" />
          </Link>
        </Reveal>
